    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_ctrl_rly1_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                ...
                {
                    btn_ctrl_rly1.Text = "&1 OFF";
                    master.WriteSingleCoil(slave_address, 11, false);
                }
                else
                {
                    btn_ctrl_rly1.Text = "&1 ON";
                    master.WriteSingleCoil(slave_address, 11, true);
                }

                bool[] status_relay = master.ReadCoils(slave_address, 11, 1);
                if (status_relay[0])
                {
                    txt_sta_rly1.Text = "Relay 1 is off now.";
                }
